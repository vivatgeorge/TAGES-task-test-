...
Выявление проблемы:
Процесс формирования и отправки часто встречающейся отчетности является время затратным
Цель: автоматизация процесса формирования и отправки отчетности с помощью telegram бота
Требования: повысить производительность и эффективность без увеличения трудозатрат
Ожидаемый результат: разработано автоматизированное средство формирования и отправки отчетности в telegram
Ресурсы, необходимые для достижения ожидаемого результата: разработанные требования для формирования различных видов отчетностей, наличие сервера, ПК или мобильного телефона, хранилище данных
Процессы (запланированные действия):
Разработать telegram бота
Привязать telegram к БД
Создать необходимые процедуры, которые будут формировать отчетность
Разработать кнопки (функционал), отвечающие за выбор отчета
Выдача прав пользователям на кнопки
...
Act (Улучшение): Если после разработки проблема не решена, - необходимо проанализировать и устранить причину проблемы.
