...
При наличии 1 старосты в каждой из 200 групп и при их активности в 8 часов в день, ежемесячная экономия времени составит 7.5/8*200 ~ 180 чел/мес.
...
![4](https://github.com/vivatgeorge/nikitin/blob/main/v3.jpg)
...
**ВЫВОДЫ**
Исходя из результатов таблицы п.10.5 можно сделать вывод, что за счет использования готовых функций и библиотек удалось сократить строки кода (языки программирования Python) в 1,1 раза. Также, за счет сокращения тестирования, объема документации, и использования CASE, удалось сократить срок разработки с 8.4 месяцев до 8. Срок окупаемости разработки сократился в 3.1 раза. На данный момент работа выполнена на 100%.
