...
![p9](https://github.com/vivatgeorge/TAGES-task-test-/blob/main/DB_TEST.jpg)
### 10. Перечень хендлеров
1)GET v1/currentuser
2)GET v1/nalogdata - собирает данные из nalog.ru
3)POST v1/userdata - создает ссылку на ресурс
4)DELETE V1/userdata - позволяет удалять ссылку на ресурс
