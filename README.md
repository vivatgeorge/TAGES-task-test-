...
|---|---|---|
| Разработка | Spaghetti code. Спагетти-код —Ход выполнения программы похож на спагетти, т.е извилистый и очень запутанный код. Иногда еще называют "кенгуру-код" (kangaroo code) из-за множества инструкций go to. | изучение правил написания кода, переписывание кода |
| Архитектура | Большой комок грязи (Big ball of mud) | разработать "читаемую" архитектуру системы |
| Организация | Аналитический паралич. Неоправданно большие затраты на анализ и проектирование. Часто приводит к закрытию проекта до начала его реализации. | проанализировать приоритеты |
